...
let rangoNumero = Number(prompt(`ingresa el numero que quieres que tenga para finalizar el rango de numeros aleatorios`));
numeroSecreto = Math.floor(Math.random()*rangoNumero)+1;
alert(numeroSecreto);
